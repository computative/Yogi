...
class Hamiltonian:
    ...
    def __init__(self, basis, params, eps = 1e-14):
        ...
        self.neighbors=[T(c( 1,-1, 1)), T(c( 1,0, 1)),T(c( 1,1, 1)),
                        T(c( 0,-1, 1)), T(c( 0,0, 1)),T(c( 0,1, 1)),
                        T(c(-1,-1, 1)), T(c(-1,0, 1)),T(c(-1,1, 1)),
                        T(c( 1,-1, 0)), T(c( 1,0, 0)),T(c( 1,1, 0)),
                        T(c( 0,-1, 0)), T(c( 0,0, 0)),T(c( 0,1, 0)),
                        T(c(-1,-1, 0)), T(c(-1,0, 0)),T(c(-1,1, 0)),
                        T(c( 1,-1,-1)), T(c( 1,0,-1)),T(c( 1,1,-1)),
                        T(c( 0,-1,-1)), T(c( 0,0,-1)),T(c( 0,1,-1)),
                        T(c(-1,-1,-1)), T(c(-1,0,-1)),T(c(-1,1,-1))]
